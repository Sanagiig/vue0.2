...
import { isTextInputType } from '@web/utils/element'
...
export const emptyNode: VNodeInstance = new VNode('', {}, [])
...
export function createPatchFunction(backend: Backend): Function {
  ...
  function invokeInsertHook (vnode:VNodeInstance, queue ?:VNodeInstance[], initial?:boolean) {
  ...
  function hydrate (elm:HTMLElement, vnode, insertedVnodeQueue?:VNodeInstance[], inVPre ?:boolean):boolean {
    return false
  }
